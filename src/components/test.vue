<template>
  ...
     </div>
        ...
        <div class="button-container">
          <button type="success" id="live" @click="liveVideo()">开启摄像头</button>
          <button type="warning" id="liveEnd">关闭摄像头</button>
          <button type="primary" id="snap">脸部跟踪开启</button>
          <button type="primary" id="clmStart">获取脸部坐标</button>
          <button type="info" id="console" @click="consoleData()">控制台输出一组数据</button>
        </div>
  </div>
</template>
